...
function VaporBarrier({ toggleRefresh, crawlSpaceData, comments }) {
  const [data, setData] = useState(crawlSpaceData.vaporBarrier);
  ...
  const options1 = {
    label: "Present",
    name: "present",
    options: ["Yes", "No", "Not visible", "Improperly installed"],
  };

  const options2 = {
    label: "Material",
    name: "material",
    options: ["Kraft/foil faced", "Plastic", "Not visible"],
  };
  const options3 = {
    label: "Condiiton",
    name: "condition",
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Vapor Barrier</p>
