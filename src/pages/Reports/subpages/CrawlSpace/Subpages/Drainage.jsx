...
function Drainage({ toggleRefresh, crawlSpaceData, comments }) {
  const [data, setData] = useState(crawlSpaceData.drainage);
  ...
  const options1 = {
    label: "Sum pump",
    name: "sumPump",
    options: ["Operable", "Not operable", "Pump not tested", "Not available"],
  };
  ...
  const options3 = {
    label: "Evidence of moisture damage",
    name: "evidenceOfMoistureDamage",
    options: ["Yes", "No"],
  };
