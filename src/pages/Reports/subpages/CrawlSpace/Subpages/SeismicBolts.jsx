...
function SeismicBolts({ toggleRefresh, crawlSpaceData, comments }) {
  const [data, setData] = useState(crawlSpaceData.seismicBolts);
  ...
  const conditionOptions = {
    label: "Condition",
    name: "condition",
    options: ["Appear satisfactory", "Recommended evaluation"],
  };
  ...
  const Options = [visibilityOptions, conditionOptions];
