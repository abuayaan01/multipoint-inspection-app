...
function Floor({ toggleRefresh, crawlSpaceData, comments }) {
  const [data, setData] = useState(crawlSpaceData.floor);
  ...
  const conditionOptions = {
    label: "Condition",
    name: "condition",
    options: ["Typical cracks", "Not visible", "Vapor barrier present"],
  };

  const materialOptions = {
    label: "Material",
    name: "material",
    options: ["Concrete", "Gravel", "Dirt"],
  };
