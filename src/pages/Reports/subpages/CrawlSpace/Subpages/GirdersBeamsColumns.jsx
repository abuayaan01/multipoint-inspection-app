...
function GirdersBeamsColumns({ toggleRefresh, crawlSpaceData, comments }) {
  const [data, setData] = useState(crawlSpaceData.girdersBeamsColumns);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    let reqData = {
      girdersBeamsColumns: { ...data, extra: extra },
    };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Girders/Beams/Columns</p>
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Editor
              ...
              value={value}
              onChange={onChange}
              comment={comments?.girdersBeamsColumns}
            />
          )}
        />
...
export default GirdersBeamsColumns;
