...
function Joists({ toggleRefresh, crawlSpaceData, comments }) {
  const [data, setData] = useState(crawlSpaceData.joists);
  ...
  const options2 = {
    label: "Condition",
    name: "condition",
    options: ["Satisfacatory", "Marginal", "Poor"],
  };
