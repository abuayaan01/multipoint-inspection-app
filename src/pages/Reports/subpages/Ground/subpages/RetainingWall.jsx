...
function RetainingWall({ toggleRefresh, groundData,comments }) {
  const [data, setData] = useState(groundData.retainingWall);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    const reqData = { retainingWall: { ...data, extra: extra } };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Retaining Wall</p>
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Editor label={"Comments"} value={value} onChange={onChange} comment={comments?.retainingWalls}/>
          )}
        />
