...
function SillPlates({ toggleRefresh, garageData, comments }) {
  const [data, setData] = useState(garageData.sillPlates);
  ...
  const typeOptions = {
    label: "Type",
    name: "type",
    options: ["Floor level", "Elevated"],
  };
  const conditionOptions = {
    label: "Condition",
    name: "condition",
    options: ["Rotted/Damaged", "Recommend repair"],
  };

  const Options = [availabilityOptions, typeOptions, conditionOptions];

  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Sill Plates</p>
