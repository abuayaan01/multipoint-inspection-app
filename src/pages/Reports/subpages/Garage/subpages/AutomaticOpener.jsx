...
function AutomaticOpener({ toggleRefresh, garageData, comments }) {
  const [data, setData] = useState(garageData?.automaticOpener);
  ...
  const onSubmit = async (data) => {
    ...
    setLoading(true);
    let reqData = {
      automaticOpener: { ...data, extra: extra },
    };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Automatic Opener</p>
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Editor
              ...
              value={value}
              onChange={onChange}
              comment={comments?.automaticOpener}
            />
          )}
        />
...
export default AutomaticOpener;
