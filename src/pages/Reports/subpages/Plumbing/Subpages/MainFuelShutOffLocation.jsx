...
function MainFuelShutOffLocation({ toggleRefresh, plumbingData, comments }) {
  const [data, setData] = useState(plumbingData.mainFuelShutOffLocation);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    let reqData = {
      mainFuelShutOffLocation: { ...data, extra: extra },
    };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Main Fuel Shut-Off Location</p>
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Editor
              ...
              value={value}
              onChange={onChange}
              comment={comments?.mainFuelShutOffLocation}
            />
          )}
        />
...
export default MainFuelShutOffLocation;
