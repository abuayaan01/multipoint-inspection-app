...
function SanitaryGrinderPump({ toggleRefresh, plumbingData, comments }) {
  const [data, setData] = useState(plumbingData.sanitaryGrinderPump);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    let reqData = {
      sanitaryGrinderPump: { ...data, extra: extra },
    };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Sanitary/Grinder Pump</p>
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Editor
              ...
              value={value}
              onChange={onChange}
              comment={comments?.sanitaryGrinderPump}
            />
          )}
        />
...
export default SanitaryGrinderPump;
