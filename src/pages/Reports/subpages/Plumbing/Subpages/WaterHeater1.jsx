...
function WaterHeater1({ toggleRefresh, plumbingData, comments }) {
  const [data, setData] = useState(plumbingData.waterHeater1);
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">WaterHeater #1</p>
