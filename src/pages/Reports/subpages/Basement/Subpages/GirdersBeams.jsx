...
function GirdersBeams({ toggleRefresh, basementData, comments }) {
  const [data, setData] = useState(basementData.girdersBeams);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    const reqData = { girdersBeams: { ...data, extra: extra } };
  ...
  const materialOptions = {
    label: "Material",
    name: "material",
    options: ["Steel", "Concrete", "Wood", "LVL", "Not Visible"],
  };
  ...
  const Options = [availabilityOptions, conditionOptions, materialOptions];
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Girders/Beams</p>
