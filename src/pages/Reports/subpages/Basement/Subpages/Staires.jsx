...
function Staires({ toggleRefresh, basementData, comments }) {
  const [data, setData] = useState(basementData.stairs);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    const reqData = { stairs: { ...data, extra: extra } };
  ...
  const handrailOptions = {
    ...
    options: [
      ...
      "Satisfactory",
      "Loose",
      "Handrail/Railing/Balusters recommended",
    ],
  };
  const headwayOverStairsOptions = {
    label: "Headway Over Stairs",
    name: "headwayOverStairs",
    options: ["Satisfactory", "Low clearance", "Safety Hazard"],
  };
  ...
  const Options = [handrailOptions, conditionOptions, headwayOverStairsOptions];

  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Stairs</p>
