...
function Joists({ toggleRefresh, basementData, comments }) {
  const [data, setData] = useState(basementData.joists);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    const reqData = { joists: { ...data, extra: extra } };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Joists</p>
