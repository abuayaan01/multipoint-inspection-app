...
function SeismicBolts({ toggleRefresh, basementData, comments }) {
  const [data, setData] = useState(basementData.seismicBolts);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    const reqData = { seismicBolts: { ...data, extra: extra } };
  ...
  const conditionOptions = {
    label: "Condition",
    name: "condition",
    options: ["Appear Satisfactory", "Recommend evaluation"],
  };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Seismic Bolts</p>
