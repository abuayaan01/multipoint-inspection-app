...
function Subfloor({ toggleRefresh, basementData, comments }) {
  const [data, setData] = useState(basementData.subfloor);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    const reqData = { subfloor: { ...data, extra: extra } };
  ...
  const conditionOptions = {
    ...
    options: [
      ...
      "Marginal",
      "Poor",
      "Indication of moisture stains/rotting",
    ],
  };
