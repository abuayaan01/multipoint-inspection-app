...
function Valleys({ toggleRefresh, roof, comments }) {
  const [data, setData] = useState(roof.valleys);
  ...
  const typeOptions = {
    label: "Type",
    name: "type",
    options: ["Gable", "Hip", "Mansard", "Shed", "Flat", "other"],
  };
  const pitchOptions = {
    label: "Pitch",
    name: "pitch",
  ...
  const valleysCheckboxes = [typeOptions, pitchOptions];
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        ...
        <div className="mt-5">
          {valleysCheckboxes.map((CheckElem, idx) => {
            return (
