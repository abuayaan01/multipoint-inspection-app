...
function Countertops({ toggleRefresh, kitchenData, comments }) {
  const [data, setData] = useState(kitchenData.countertops);
  ...
  const option1 = {
    label: "Condition",
    name: "condition",
    options: ["Satisfactory", "Marginal", "Recommend repair/caulking"],
  };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Countertops</p>
