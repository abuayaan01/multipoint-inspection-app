...
function Cabinets({ toggleRefresh, kitchenData, comments }) {
  const [data, setData] = useState(kitchenData.cabinets);
  ...
  const option1 = {
    label: "Condition",
    name: "condition",
    options: ["Satisfactory", "Marginal", "Recommend repair/adjustment"],
  };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Cabinets</p>
