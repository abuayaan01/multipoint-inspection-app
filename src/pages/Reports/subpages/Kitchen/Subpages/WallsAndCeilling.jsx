...
function WallsAndCeilling({ toggleRefresh, kitchenData, comments }) {
  const [data, setData] = useState(kitchenData.wallsAndCeilling);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    let reqData = {
      wallsAndCeilling: { ...data, extra: extra },
    };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Walls & Ceilling</p>
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Editor
              ...
              value={value}
              onChange={onChange}
              comment={comments?.wallsAndCeilling}
            />
          )}
        />
...
export default WallsAndCeilling;
