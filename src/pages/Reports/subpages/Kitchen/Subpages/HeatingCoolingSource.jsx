...
function HeatingCoolingSource({ toggleRefresh, kitchenData, comments }) {
  const [data, setData] = useState(kitchenData.heatingCoolingSource);
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    let reqData = {
      heatingCoolingSource: { ...data, extra: extra },
    };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Heating/Cooling Source</p>
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Editor
              ...
              value={value}
              onChange={onChange}
              comment={comments?.heatingCoolingSource}
            />
          )}
        />
...
export default HeatingCoolingSource;
