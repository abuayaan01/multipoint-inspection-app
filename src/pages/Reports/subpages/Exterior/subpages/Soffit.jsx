...
function Soffit({ toggleRefresh, exterior, comments }) {
  const [data, setData] = useState(exterior.soffit);
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Soffit</p>
