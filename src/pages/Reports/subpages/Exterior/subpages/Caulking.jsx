...
function Caulking({ toggleRefresh, exterior, comments }) {
  const [data, setData] = useState(exterior.caulking);
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">Caulking</p>
