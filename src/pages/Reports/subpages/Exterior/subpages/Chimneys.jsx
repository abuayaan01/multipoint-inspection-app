...
function Chimneys({ toggleRefresh, exterior, comments }) {
  const [data, setData] = useState(exterior.chimneys);
  ...
  const evidenceOfOptions = {
    ...
    options: [
      ...
      "Not evaluated",
      "Have flue(s)",
      "cleaned and re-evaluated",
      "Recommend Cricket/Saddle/Flashing",
      "No apparent defects",
    ],
  };
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="editForm">
        <p className="headTitle">{"Chimney(s)"}</p>
